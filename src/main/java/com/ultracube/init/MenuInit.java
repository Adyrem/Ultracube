...
public class MenuInit {
        ...
        public static final Supplier<MenuType<EnergyGeneratorMenu>> ENERGY_GENERATOR_MENU = MENU_TYPES.register(
                        "energy_generator_menu",
                        () -> IMenuTypeExtension.create(EnergyGeneratorMenu::new));

        public static final Supplier<MenuType<CubeEnergyExtractorMenu>> CUBE_ENERGY_EXTRACTOR_MENU = MENU_TYPES
                        .register("cube_energy_extractor_menu",
                                        () -> IMenuTypeExtension.create(CubeEnergyExtractorMenu::new));

        public static final Supplier<MenuType<CubeMatterCreatorMenu>> CUBE_MATTER_CREATOR_MENU = MENU_TYPES.register(
                        "cube_matter_creator_menu",
