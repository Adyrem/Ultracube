...
public class ItemInit {
    ...
    public static final DeferredItem<BlockItem> ENERGY_GENERATOR_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("energy_generator_block",
        BlockInit.ENERGY_GENERATOR_BLOCK, new Item.Properties()
        );

    public static final DeferredItem<BlockItem> CUBE_ENERGY_EXTRACTOR_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("cube_energy_extractor_block",
