...
public class CreativeTabInit {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, Ultracube.MODID);

    public static final List<Supplier<? extends ItemLike>> ULTRACUBE_ITEMS = new ArrayList<>();

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ULTRACUBE_TAB = CREATIVE_MODE_TABS.register("ultracube_tab",
            () -> CreativeModeTab.builder()
                    ...
                    ULTRACUBE_ITEMS.forEach(itemLike -> output.accept(itemLike.get())))
                    .build()
    );
