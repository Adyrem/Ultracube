...
public class BlockInit {
    ...
    public static final DeferredBlock<EnergyGeneratorBlock> ENERGY_GENERATOR_BLOCK = BLOCKS.registerBlock("energy_generator_block", 
        EnergyGeneratorBlock::new,
        BlockBehaviour.Properties.of()
        .mapColor(MapColor.STONE)
    );

    public static final DeferredBlock<CubeEnergyExtractorBlock> CUBE_ENERGY_EXTRACTOR_BLOCK = BLOCKS.registerBlock("cube_energy_extractor_block", 
